    ...
    <div class="horizontal-center">
        <div class="center-content justify">
            ...
            <p>
                ...
                1. Check your local internet connection and ensure your browser or ad-blocker is not blocking API requests to <code>notefox.eu</code>.<br>
                2. If the API or Database is temporarily unavailable, maintenance might be currently underway. Please wait a few moments and click <strong>"Run Check Again"</strong>.<br>
