...
<head>
    <?php
    $docs_title = "/v1/login/set-expiry/";
    ...
    <div class="horizontal-center ">
        <div class="center-content justify">
            ...
            <h2 class="subtitle-section no-bold font-small">
                This API permits to set the expiry of a login-id. The expiry is set to "undefined" by default.
            </h2>
            <p>
                <b>API Link</b>
                <code>
            ...
            <p>
                ...
                <br>
                <code>expiry</code> (DATETIME): the new expiry date for the login-id
            </p>
            <p>
