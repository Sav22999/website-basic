...
<head>
    <?php
    $docs_title = "/v1/logout/";

    include_once($_SERVER['DOCUMENT_ROOT'] . "/old/include/docs-functions.php");
    ...
    <div class="horizontal-center ">
        <div class="center-content justify">
            ...
            <h2 class="subtitle-section no-bold font-small">
                This API permits to log out the user. The login-id and tokens will be disabled.
                <br>
                You can also use this API to log out the user from all devices, by sending the optional GET parameter
                <code>all-devices=true</code>.
            </h2>
            <p>
                <b>API Link</b>
                <code>
            ...
            <p>
                ...
                <br>
                <code>451</code>: <?php echo getErrorDescription(451); ?>
            </p>
        </div>
    </div>
</main>
