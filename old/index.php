...
?>
    <html>
    <head>
        <?php include_once($root_path . "/old/include/header.php"); ?>
    </head>
    <body>
    <?php
    $selected_menu = "home";
    include_once($root_path . "/old/include/menu.php");
    ?>

    <main>
        <div class="vertical-middle">
            <div class="horizontal-center">
                <img src="<?php echo $path; ?>/images/icon.png" class="image-square-100px">
                <h1 class="title-section merienda">Notefox</h1>
                <h2 class="subtitle-section no-bold font-small merienda">
                    <b>Take notes</b> on every website in a <b>smart</b> and <b>simple</b> way!</h2>
                <br>
                <br>
                <input type="button" class="button button-with-icon button-install" value="Install"
                       onclick="location.href='<?php echo $path; ?>/install/'">
                <br>
                <br>
    ...
    <footer class="font-color-tertiary-color-variant horizontal-center font-very-small">
        ...
        <br>
        <a href="<?php echo $path; ?>/privacy/">Privacy policy</a> | <a href="<?php echo $path; ?>/terms/">Terms of
            service</a>
    </footer>
