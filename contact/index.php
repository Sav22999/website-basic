...
include_once($root_path . "/include/altcha.php");
...
$config_path = $root_path . '/include/mail-config.php';
$hmac_key = '';
...
<main id="main" class="page">
    <div class="container">
        <a href="/help/" class="back-link"><?php echo te('common.back'); ?></a>
        ...
        <div id="contact-success" class="auth-card text-center" style="max-width: 560px; display: none;">
            ...
            <div class="form-actions">
                <a href="/help/" class="btn"><?php echo te('contact.success_back'); ?></a>
            </div>
        </div>
    </div>
</main>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        form.addEventListener("submit", function (e) {
            ...
            fetch("/contact/send.php", {method: "POST", body: fd})
                .then(function (r) {
