...
function nav_link($slug, $label, $selected_menu)
{
    $href = $slug === "" ? "/" : "/" . $slug . "/";
    $key = $slug === "" ? "home" : $slug;
...
<header class="site-header">
    ...
    <nav class="site-nav" aria-label="Main navigation">
        <a href="/" class="nav-logo" aria-label="Notefox home">
        ...
        <div class="nav-links">
            <?php echo nav_link("", t('nav.home'), $selected_menu); ?>
            <?php echo nav_link("about", t('nav.about'), $selected_menu); ?>
            <?php echo nav_link("help", t('nav.help'), $selected_menu); ?>
            <?php echo nav_link("news", t('nav.news'), $selected_menu); ?>
            <?php echo nav_link("donate", t('nav.donate'), $selected_menu); ?>
            <?php echo nav_link("install", t('nav.install'), $selected_menu); ?>
            <?php echo nav_link("my", t('nav.account'), $selected_menu); ?>
