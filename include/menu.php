...
<header class="site-header">
    <div class="site-header__inner">
        ...
        <nav class="nav">
            <a href="/" class="<?php echo menu_class("home", $selected_menu); ?>" data-i18n="nav.home">Home</a>
            <a href="/install/" class="<?php echo menu_class("install", $selected_menu); ?>"
               data-i18n="nav.install">Install</a>
            <a href="/help/" class="<?php echo menu_class("help", $selected_menu); ?>"
            ...
            <div class="lang-dropdown" id="lang-dropdown">
                <button type="button" class="lang-trigger" id="lang-trigger" onclick="toggleLangDropdown()">
                    <svg class="lang-trigger__icon" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12.87 15.07l-2.54-2.51.03-.03A17.52 17.52 0 0014.07 6H17V4h-7V2H8v2H1v2h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z"/>
                    </svg>
                    <span class="lang-trigger__code" id="lang-trigger-code">EN</span>
                    <svg class="lang-trigger__chevron" viewBox="0 0 12 12" fill="none" stroke="currentColor"
                ...
                <div class="lang-panel" id="lang-panel">
                    ...
                    <button type="button" class="lang-item" data-lang="pt-BR"
                            onclick="setLang('pt-BR'); closeLangDropdown()">
                        <span class="lang-item__code">PT-BR</span>
                        <span class="lang-item__name">Português (BR)</span>
                    </button>
                    <button type="button" class="lang-item" data-lang="pt-PT"
                            onclick="setLang('pt-PT'); closeLangDropdown()">
                    ...
                    <button type="button" class="lang-item" data-lang="zh-CN"
                            onclick="setLang('zh-CN'); closeLangDropdown()">
