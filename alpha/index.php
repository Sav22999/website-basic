...
<main id="main">
    <section class="page-hero home-hero">
        ...
        <div class="container text-center" style="position: relative;">
            ...
            <p class="page-subtitle"><strong>Take notes</strong> on every website in a <strong>smart</strong> and <strong>simple</strong> way!</p>
            ...
            <div class="btn-group hero-secondary-links">
                <a href="https://liberapay.com/Sav22999/donate" class="btn btn--secondary" target="_blank" rel="noopener"><span class="btn-icon icon-mask icon-mask--liberapay" aria-hidden="true"></span> LiberaPay</a>
                <a href="https://paypal.me/saveriomorelli" class="btn btn--secondary" target="_blank" rel="noopener"><span class="btn-icon icon-mask icon-mask--paypal" aria-hidden="true"></span> PayPal</a>
                <a href="https://github.com/Sav22999/websites-notes" class="btn btn--secondary" target="_blank" rel="noopener"><span class="btn-icon icon-mask icon-mask--github" aria-hidden="true"></span> GitHub</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="home-features">
                <div class="home-feature">
                    ...
                    <p>No ads, no tracking, no analytics. Your data stays on your device or encrypted on our servers.</p>
                </div>
                <div class="home-feature">
                    <div class="home-feature-icon">
