...
<main>
    ...
    <section class="hero">
        <div class="hero__inner">
            ...
            <div class="button-group">
                <a href="/alpha/install/" class="button button-with-icon button-lg">
            ...
            <div class="feature-visual">
                <div class="phone-duo">
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-reading.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-reading.png" alt="Clean reading">
                    </div>
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-settings.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-settings.png" alt="Settings">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="feature-section feature-section--reverse">
        <div class="feature__inner">
            ...
            <div class="feature-visual">
                <div class="phone-duo">
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-search.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-search.png" alt="Search">
                    </div>
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-select.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-select.png" alt="Select text">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="feature-section">
        <div class="feature__inner">
            ...
            <div class="feature-visual">
                <div class="phone-duo">
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-bookmarks.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-bookmarks.png" alt="Bookmarks">
                    </div>
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-share.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-share.png" alt="Share">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="feature-section feature-section--reverse">
        <div class="feature__inner">
            ...
            <div class="feature-visual">
                <div class="phone-duo">
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-recents.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-recents.png" alt="Recent files">
                    </div>
                    <div class="phone-mockup">
                        <img src="/alpha/images/home/en/screen-password.png"
                             data-i18n-src="/alpha/images/home/{lang}/screen-password.png" alt="Password-protected PDF">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-section">
        ...
        <div class="button-group">
            <a href="/alpha/install/" class="button button-with-icon">
                <span class="button__icon button-icon-install"></span><span
