        ...
        <div id="contact-form-wrapper" class="auth-card" style="max-width: 560px;">
            ...
            <form id="contact-form" class="form-container" novalidate>
                ...
                <div class="form-field">
                    <label class="form-label" for="contact-name"><?php echo te('contact.name_label'); ?> <span class="form-hint form-hint--required"><?php echo te('contact.required_hint'); ?></span></label>
                    <input class="form-input" type="text" id="contact-name" name="name" maxlength="128" required>
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-email"><?php echo te('contact.email_label'); ?> <span class="form-hint form-hint--required"><?php echo te('contact.required_hint'); ?></span></label>
                    <input class="form-input" type="email" id="contact-email" name="email" maxlength="320" required>
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-topic"><?php echo te('contact.topic_label'); ?> <span class="form-hint form-hint--required"><?php echo te('contact.required_hint'); ?></span></label>
                ...
                <div class="form-field form-field--conditional" id="topic-other-wrap" style="display:none;">
                    <input class="form-input" type="text" id="contact-topic-other" name="topic_other" maxlength="128" placeholder="<?php echo te('contact.specify_placeholder'); ?>">
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-version"><?php echo te('contact.version_label'); ?> <span class="form-hint form-hint--optional"><?php echo te('contact.optional_hint'); ?></span></label>
                    <input class="form-input" type="text" id="contact-version" name="version" maxlength="32" placeholder="<?php echo te('contact.version_placeholder'); ?>">
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-browser"><?php echo te('contact.browser_label'); ?> <span class="form-hint form-hint--required"><?php echo te('contact.required_hint'); ?></span></label>
                ...
                <div class="form-field form-field--conditional" id="browser-other-wrap" style="display:none;">
                    <input class="form-input" type="text" id="contact-browser-other" name="browser_other" maxlength="64" placeholder="<?php echo te('contact.specify_placeholder'); ?>">
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-os"><?php echo te('contact.os_label'); ?> <span class="form-hint form-hint--optional"><?php echo te('contact.optional_hint'); ?></span></label>
                ...
                <div class="form-field form-field--conditional" id="os-other-wrap" style="display:none;">
                    <input class="form-input" type="text" id="contact-os-other" name="os_other" maxlength="64" placeholder="<?php echo te('contact.specify_placeholder'); ?>">
                </div>

                <div class="form-field">
                    <label class="form-label" for="contact-message-input"><?php echo te('contact.message_label'); ?> <span class="form-hint form-hint--required"><?php echo te('contact.required_hint'); ?></span></label>
                    <textarea class="form-input form-textarea" id="contact-message-input" name="message" rows="6" required></textarea>
                </div>

                <div class="captcha-card">
                    <div class="captcha-main">
                        <altcha-widget challengejson='<?php echo htmlspecialchars($challenge_json, ENT_QUOTES, 'UTF-8'); ?>' hidefooter hidelogo></altcha-widget>
                    </div>
                </div>
                <a href="https://altcha.org" target="_blank" rel="noopener" class="captcha-footer">
                    Protected by
                    <svg class="captcha-footer-logo" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.33955 16.4279C5.88954 20.6586 12.1971 21.2105 16.4279 17.6604C18.4699 15.947 19.6548 13.5911 19.9352 11.1365L17.9886 10.4279C17.8738 12.5624 16.909 14.6459 15.1423 16.1284C11.7577 18.9684 6.71167 18.5269 3.87164 15.1423C1.03163 11.7577 1.4731 6.71166 4.8577 3.87164C8.24231 1.03162 13.2883 1.4731 16.1284 4.8577C16.9767 5.86872 17.5322 7.02798 17.804 8.2324L19.9522 9.01429C19.7622 7.07737 19.0059 5.17558 17.6604 3.57212C14.1104 -0.658624 7.80283 -1.21043 3.57212 2.33956C-0.658625 5.88958 -1.21046 12.1971 2.33955 16.4279Z" fill="currentColor"/><path d="M3.57212 2.33956C1.65755 3.94607 0.496389 6.11731 0.12782 8.40523L2.04639 9.13961C2.26047 7.15832 3.21057 5.25375 4.8577 3.87164C8.24231 1.03162 13.2883 1.4731 16.1284 4.8577L13.8302 6.78606L19.9633 9.13364C19.7929 7.15555 19.0335 5.20847 17.6604 3.57212C14.1104 -0.658624 7.80283 -1.21043 3.57212 2.33956Z" fill="currentColor"/><path d="M7 10H5C5 12.7614 7.23858 15 10 15C12.7614 15 15 12.7614 15 10H13C13 11.6569 11.6569 13 10 13C8.3431 13 7 11.6569 7 10Z" fill="currentColor"/></svg>
                    Altcha
                </a>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn--block" id="contact-submit" disabled><?php echo te('contact.submit'); ?></button>
                </div>
            </form>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        try { document.getElementById("contact-timezone").value = Intl.DateTimeFormat().resolvedOptions().timeZone || ""; } catch(e) {}
        ...
        function setupConditional(selectId, wrapId, inputId) {
            ...
            sel.addEventListener("change", function () {
                ...
                if (show) { inp.required = true; inp.focus(); }
