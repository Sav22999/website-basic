    ...
    <section class="error-page">
        <div class="error-page__inner">
            <svg class="error-page__illustration" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="58" y="40" width="64" height="84" rx="4" stroke="#d32f2f" stroke-width="2.5" fill="rgba(211,47,47,0.08)"/>
                <path d="M102 40v20h20" stroke="#d32f2f" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
                ...
                <text x="80" y="60" font-family="sans-serif" font-size="7" font-weight="700" fill="white" text-anchor="middle">PDF</text>
                <!-- Question mark -->
                <path d="M83 86a8 8 0 0 1 14-5.3 7 7 0 0 1-4 12.3v3" stroke="#d32f2f" stroke-width="2.5" stroke-linecap="round" fill="none"/>
            ...
            <p class="error-page__desc">We looked everywhere, but this page seems to have wandered off. Let's get you back on track.</p>
