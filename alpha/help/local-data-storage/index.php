...
$title = "Local data storage – Notefox";
$selected_menu = "help";
...
<main id="main" class="page">
    <div class="container">
        ...
        <h1>Where your data is stored locally</h1>
        ...
        <p>
            <strong>Pay attention</strong>: data synced with a Notefox Account is stored in the cloud, and it is encrypted
            server-side.
        </p>
    </div>
</main>
