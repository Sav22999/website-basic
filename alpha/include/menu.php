...
<header class="site-header">
    <div class="site-header__inner">
        ...
        <nav class="nav">
            ...
            <a href="/alpha/install/" class="<?php echo menu_class("install", $selected_menu); ?>"
               data-i18n="nav.install">Install</a>
            <a href="/alpha/help/" class="<?php echo menu_class("help", $selected_menu); ?>"
               data-i18n="nav.help">Help</a>
            <a href="/alpha/news/" class="<?php echo menu_class("news", $selected_menu); ?>"
