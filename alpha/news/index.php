...
<main>
    <section class="hero hero--compact">
        <div class="hero__inner">
            ...
            <div class="lang-notice" data-i18n="news.lang_notice" style="display: none;">This page is available in English only</div>
        </div>
    </section>
    ...
    <section class="faq-section">
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--improved">improved</span> Search feature now supports multi-word queries</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Panel was behind the system navigation bar on Android API 35+</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> All pages were loaded on startup causing slow loading</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Double-byte characters not showing correctly in file names</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Optimized reverse (RTL) swiping to reuse stored page count</li>
                <li><span class="changelog-label changelog-label--new">new</span> Added total_pages column with DB migration to version 5</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Minor improvements</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Support for AES-256 protection</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Separated per-ABI builds</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                ...
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Swiping bottom-up and right-left</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Changed main library to FOSS and removed unnecessary permissions</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Text selection, copy, and filters</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Search feature in the menu panel</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Lock rotation feature in the menu panel</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Moved share button to the topbar</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Some bug fixes</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Confirmation dialog before opening links</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Some bug fixes</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--improved">improved</span> Minor improvements</li>
                <li><span class="changelog-label changelog-label--new">new</span> Icon now supports monochrome theme</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Some bugs from the previous version</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                ...
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Some bug fixes</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Backend improvements</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Closure when PDFs were opened by external apps</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--improved">improved</span> Share feature: now you can share every opened file</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Tap on page to hide/show the topbar</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                ...
                <li><span class="changelog-label changelog-label--new">new</span> All bookmarks button in the menu panel</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                ...
                <li><span class="changelog-label changelog-label--new">new</span> Page number shown during scrollbar navigation</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Scrollbar button for faster navigation</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Many bug fixes</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Bookmark animations and gestures</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Bookmarks: add, remove and manage bookmarks</li>
                <li><span class="changelog-label changelog-label--improved">improved</span> Backend code and frontend UI</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Menu panel for small-display devices</li>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Top bar disappears after 5 seconds of inactivity</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Page restored after orientation change</li>
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Share feature not working correctly</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--fixed">fixed</span> Fit width when changing orientation</li>
            </ul>
        </div>
        ...
        <div class="expanding-item--expanded-details hidden">
            <ul class="changelog-list">
                <li><span class="changelog-label changelog-label--new">new</span> Support for password-protected PDFs</li>
