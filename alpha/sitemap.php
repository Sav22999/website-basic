...
?>
        <xhtml:link rel="alternate" hreflang="<?php echo $alt; ?>" href="<?php echo htmlspecialchars($href); ?>"/>
<?php endforeach; ?>
        <xhtml:link rel="alternate" hreflang="x-default" href="<?php echo htmlspecialchars($base . $page["path"]); ?>"/>
