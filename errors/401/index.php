    ...
    <section class="error-page">
        <div class="error-page__inner">
            <svg class="error-page__illustration" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="60" y="78" width="60" height="50" rx="6" stroke="#d32f2f" stroke-width="3"
                      fill="rgba(211,47,47,0.1)"/>
                <path d="M72 78V64a18 18 0 0 1 36 0v14" stroke="#d32f2f" stroke-width="3" stroke-linecap="round"
                      fill="none"/>
            ...
            <p class="error-page__desc">You need to sign in to access this page. If you think this is an error, try
                going back to the homepage.</p>
