...
<main id="main" class="page">
    <div class="container">
        ...
        <div class="account-cards">
            <a href="/my/account/notes/" class="account-card">
            ...
            <a href="/my/account/sync-history/" class="account-card">
                <svg class="account-card-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="account-card account-card--static" id="otp-card">
                ...
                <div class="account-card--static-body">
                    <div class="account-card--static-inner">
                        ...
                        <a href="/my/account/two-factor/" class="btn btn--secondary btn--small"><?php echo te('account.otp_manage'); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="account-actions">
            <a href="/my/account/password/" class="btn btn--secondary"><?php echo te('account.change_password'); ?></a>
            <a href="/my/account/delete/" class="btn btn--danger"><?php echo te('account.delete_account'); ?></a>
