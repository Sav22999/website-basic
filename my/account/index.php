    ...
    <div class="horizontal-center">
        <div class="center-content">
            ...
            <div class="account-section">
                ...
                <a href="/my/account/two-factor/" class="button">Manage two-step verification</a>
            </div>

            <div class="account-links">
                <a href="/my/account/sync-history/" class="button button-secondary">Sync history</a>
                <a href="/my/account/password/" class="button button-secondary">Change password</a>
                <a href="/my/account/delete/" class="button button-secondary">Delete account</a>
